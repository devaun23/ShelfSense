...
export default function EnhancedExplanation({
  explanation,
  correctAnswer,
  userAnswer,
  isCorrect,
    ...
    return (
      <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4">
        <p className="text-gray-300 text-sm leading-relaxed">
          {explanation.quick_answer || explanation.principle}
        </p>
      </div>
    );
  }
  ...
  if (mode === 'compact') {
    return (
      <div className="bg-gray-900/50 border border-gray-800 rounded-xl p-4 space-y-3">
        ...
        <p className="text-gray-400 text-sm">{explanation.correct_answer_explanation}</p>
      </div>
    );
  }
